...
<div class="container">
  <div class="content">
    ...
    <div class="empty-state">
      ...
      <h2>No Approved Properties Yet</h2>
      <p>You don't have any approved properties yet. Submit properties for approval and they will appear here once reviewed.</p>
      <a href="add_property.php" class="btn btn-primary" style="display: inline-block; margin-top: 1rem; padding: 0.75rem 1.5rem; background: var(--primary); color: white; text-decoration: none; border-radius: 6px; font-weight: 600;">
